				...
				{CATEGORIES.map((cat) => {
					...
					return (
						<button
							...
							className={`px-4 py-2 text-sm font-medium rounded-full transition-all duration-250 ease-[cubic-bezier(0.4,0,0.2,1)] ${isActive
						...
						>
							{cat.label}
							<span
								className={`ml-1.5 text-xs ${isActive ? 'text-white/60' : 'text-[#1a1a2e]/30'
									}`}
							>
								{count}
							</span>
