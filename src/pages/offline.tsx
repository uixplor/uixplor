	...
	return (
		<>
			...
			>
				...
				{/* Floating blobs — cyan/blue */}
				<motion.div
					className="absolute rounded-full pointer-events-none"
					style={{ width: 420, height: 420, background: 'radial-gradient(circle, rgba(34,211,238,0.08) 0%, transparent 70%)', top: '-10%', right: '-5%' }}
					animate={{ x: [0, -30, 0], y: [0, 25, 0], scale: [1, 1.1, 1] }}
					transition={{ duration: 9, repeat: Infinity, repeatType: 'mirror', ease: 'easeInOut' }}
				/>
				<motion.div
					className="absolute rounded-full pointer-events-none"
					style={{ width: 350, height: 350, background: 'radial-gradient(circle, rgba(99,102,241,0.07) 0%, transparent 70%)', bottom: '-5%', left: '-8%' }}
					animate={{ x: [0, 25, 0], y: [0, -20, 0], scale: [1, 1.08, 1] }}
					transition={{ duration: 11, repeat: Infinity, repeatType: 'mirror', ease: 'easeInOut', delay: 2 }}
				/>
				<motion.div
					className="absolute rounded-full pointer-events-none"
					style={{ width: 200, height: 200, background: 'radial-gradient(circle, rgba(34,211,238,0.06) 0%, transparent 70%)', top: '60%', right: '10%' }}
				...
				>
					...
					>
						...
						<svg className="w-9 h-9 relative z-10" fill="none" stroke="#22d3ee" viewBox="0 0 24 24">
				...
				>
					...
					<div
						...
						style={{
							background: 'linear-gradient(135deg, #22d3ee 0%, #818cf8 50%, #38bdf8 100%)',
				...
				>
					<motion.div whileHover={{ scale: 1.06 }} whileTap={{ scale: 0.97 }}>
						<button
							...
							style={{ background: 'linear-gradient(135deg, #22d3ee, #818cf8)', color: '#0a0a0f' }}
							onMouseEnter={e => (e.currentTarget.style.boxShadow = '0 0 30px rgba(34,211,238,0.4)')}
